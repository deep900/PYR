...
public class DAOConfig {
	...
	private String appKey="Mopcp99PdHVK5jtYneDEwA==";
	...
	public SessionFactory getSessionFactory() {
		...
		props.put(Environment.CONNECTION_PROVIDER, CustomConnectionProvider.class);
	...
	/*
	 * Using dbcp db connection to establish a persistant relationship.
	 * Changed 29-Aug-2017
	 */
	@Bean(name="sessionFactory")
	...
	public CustomConnectionProvider getConnectionProvider() {
		CustomConnectionProvider datasourceConnectionProvider = new CustomConnectionProvider(getDataSource());
	...
	public org.apache.commons.dbcp.BasicDataSource getDataSource() {
		...
		dataSource.setPassword(PublicUtility.getInstance(appKey).DecryptText(prop.getProperty("password")));
