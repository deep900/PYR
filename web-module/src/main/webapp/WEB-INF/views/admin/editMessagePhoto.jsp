					...
					<section class="grid">
						<div class="heading-holder">
							<h3 class="content-heading">
								<span><em class="h-left"></em><span class="inner-heading">Add
										Message</span><em class="h-right"></em></span>
							</h3>
						</div>
						<article>
							<div>
								<div>
									<div>
										<form method="POST" name="editPhotoForm"
											action="${context}/admin/editMessagePhotoAction?id=${messageId}&imageType=small"
											...
											<fieldset>
												<div class="cleanform">
													<table>
														<tr>
															<td>SM Photo</td>
															<td><input type="file" name="smImage" /></td>
														</tr>
														<tr><td><input name="" type="submit" value="SUBMIT">
														</td>
														</tr>
													</table>
											</fieldset>
										...
										<form method="POST" name="editPhotoForm"
											action="${context}/admin/editMessagePhotoAction?id=${messageId}&imageType=large"
											enctype="multipart/form-data">
											<fieldset>
												<div class="cleanform">
													<table>
														<tr>
															<td>LM Photo</td>
															<td><input type="file" name="lmImage" /></td>
														</tr>
