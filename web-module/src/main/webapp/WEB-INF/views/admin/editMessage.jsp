...
document.getElementById('messageEnglish').value = document.getElementById('messageEngData').value;
document.getElementById('messageTamil').value = document.getElementById('messageTamilData').value;
}
</script>
...
<body onload="loadDefaultValues()">
	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<div>
			<input type="hidden" value="${engMsg}" id="messageEngData"/>
			<input type="hidden" value="${taMsg}" id="messageTamilData"/>
			</div>
            ...
            <div>
              <div>
                <div>
                  ...
                  <form:form name="editMessageForm" method="post" action="${context}/admin/editMessageAction?id=${id}">
                    <fieldset>
                      <!-- <div class="row"> -->
                      ...
                      <table>
                        ...
                        <tr><td>Title English </td><td><form:textarea path="messageTitleEnglish" /> </td></tr>
                        <tr><td>Title Tamil </td><td><form:textarea path="messageTitleTamil" /> </td></tr>
                        ...
                        <tr><td>Message English</td><td><form:textarea path="messageEnglish"  value='${engMsg}'/> </td></tr>
                        <tr><td>Message Tamil </td><td><form:textarea path="messageTamil" value='${taMsg}'/> </td></tr>                                            
