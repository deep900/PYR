					...
					<section class="grid">
						<div class="heading-holder">
							<h3 class="content-heading">
								<span><em class="h-left"></em><span class="inner-heading">View Added Bible Quiz</span><em class="h-right"></em></span>
							</h3>
						</div>
							...
							<div class="blog-post-admin">
								...
								<tbody>
								<c:forEach items="${bibleQuizList}" var="bqModel">
										<tr>										
										...
										<td><c:out value="${bqModel.choice}"></c:out></td>
