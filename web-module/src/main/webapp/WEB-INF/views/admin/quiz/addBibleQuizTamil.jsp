      ...
      <section class="grid-holder">
        <section class="grid">
          <div class="heading-holder">
            <h3 class="content-heading"><span><em class="h-left"></em><span class="inner-heading">Add Bible Quiz Tamil</span><em class="h-right"></em></span></h3>
          </div>
          <article>
            <div>
              <div>
                <div>
                  <form:form name="addBibleQuizForm" method="post" action="${context}/admin/addBibleQuizTamilAction">
                    <fieldset>
                      <!-- <div class="row"> -->
                        <div class="cleanform">                       
                        ...
                        <td><form:textarea path="choice"/>                        
                         ...
                         <tr>
                        <td>Correct Answer (Tamil) </td>
                        <td><form:textarea path="correctAnswer"/>                        
                        </td>
                        </tr>
                        
                         <tr>
                        <td>Bible Reference (Tamil) </td>
