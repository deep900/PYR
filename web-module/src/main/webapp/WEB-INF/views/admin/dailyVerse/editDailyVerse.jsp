      ...
      <section class="grid-holder">
        <section class="grid">
          <div class="heading-holder">
            <h3 class="content-heading"><span><em class="h-left"></em><span class="inner-heading">Edit Bible Verse</span><em class="h-right"></em></span></h3>
          </div>
          <article>
            <div>
              <div>
                <div>
                  <form:form name="editBibleVerseForm" method="post" action="${context}/admin/editBibleVerseAction">
                    <fieldset>
                      <!-- <div class="row"> -->
                        <div class="cleanform">                        
                        ...
                        <table>
                        <tr>
                        <td>Eng Chapter </td><td><form:textarea path="engChapter" />
                        </td>
                        </tr>
                         <tr>
                        <td>Eng Verse </td><td><form:textarea path="engVerse" />
                        </td>
                        </tr>
                        <tr>
                        <td>Tamil Chapter </td><td><form:textarea path="chapter" />
                        </td>
                        </tr>
                         <tr>
                        <td>Tamil Verse </td><td><form:textarea path="verse" />
                        </td>
                        </tr>
                        <tr>
                        <td>
                      <input name="" type="submit" value="SUBMIT"></td>
                      <a href="${context}/admin/viewAllDailyVerses" >Cancel</a>
                      </tr>
                      </table>
                    </fieldset>
