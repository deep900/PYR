      ...
      <section class="grid-holder">
        <section class="grid">
          <div class="heading-holder">
            <h3 class="content-heading"><span><em class="h-left"></em><span class="inner-heading">Add Daily Verse</span><em class="h-right"></em></span></h3>
          </div>
          <article>
            <div>
              <div>
                <div>
                  <form:form name="addDailyVerseForm" method="post" action="${context}/admin/addDailyVerseAction">
                    <fieldset>
                      <!-- <div class="row"> -->
                        <div class="cleanform">
                        ...
                        <table>
                        <tr><td>Daily Verse Tamil </td><td><form:textarea path="verse" />
                        </td>
                        </tr>
                        <tr><td>Daily Verse Tamil Chapter </td><td><form:textarea path="chapter" />
                        </td>
                        </tr>
                        
                        <tr><td>Daily Verse Eng </td><td><form:textarea path="engVerse" />
                        </td>
                        </tr>
                        <tr><td>Daily Verse Eng Chapter </td><td><form:textarea path="engChapter" />
                        </td>
                        </tr>
