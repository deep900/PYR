				...
				<header id="header">
					<div class="header-wrapper home subnav-fixed">
						<div class="header-holder">
							...
							<!-- </h1> -->
							<div class="nav">							
							<div style="float:left;width:50%;color:orange;font-size:17px;margin-top: 22px;font-family:satisfy"><spring:message code="mainpage.banner.verse1.title"/></div>
						...
						<div class="gholder">
							...
							<div class="gmask">
								<ul>
									...
									<li><img src=<c:url value="/resources/images/banner-img-2.jpg"/> alt="image" />
										<div class="left">
									 ...
									 <li><img src=<c:url value="/resources/images/banner-img-3.jpg"/> alt="image" />
										<div class="left">
											<div class="banner-caption">
										 ...
										 <li><img src=<c:url value="/resources/images/banner-img-4-1.jpg"/> alt="image" />
										<div class="left">
											<div class="banner-caption">
						...
						<div class=" holder">
							<div class="music-bar">
								<audio controls autoplay loop style="width:100%">									
									<source src=<c:url value="/resources/music/Give_Thanks1.mp3"/> type="audio/mpeg">
  									<source src=<c:url value="/resources/music/Give_Thanks1.ogg"/> type="audio/ogg">
								</audio>
							</div>
						</div>
					</div>
