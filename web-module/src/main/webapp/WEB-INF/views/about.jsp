					...
					<section class="grid">
						<div class="heading-holder">
							<h3 class="content-heading">
								<span><em class="h-left"></em><span class="inner-heading">About This Website</span><em class="h-right"></em></span>
							</h3>
						</div>
						<article class="column">
							<div class="blog-post">
								...
								<div class="blog-holder">
									<p>
									This website is founded on 11-June-2017 with a vision of telling the truth that we have seen and experienced with our LORD Jesus Christ. We glorify the LORD Jesus who has brought us through. He has given us this ministry to share the knowledge of the living god and his goodness. He provides protection and shows his grace to all people who believes in him and obey his words truly and do good to others.
									</p>
									<p>
									His preaching and his words are true and we found this when we followed him. This website gives focus to his words and helps people in guiding towards him. There are many prayers, messages , life transforming verses and quiz from bible to improve your knowledge.</p>
									
									<p>
									We are working always to improve the quality of this website. You can write your feedback to <a href="mailto:administrator@praiseyourredeemer.org?Subject=Feedback">administrator@praiseyourredeemer.org</a>
									</p>
									<p>
									We are working in Tamil and English content,would like to get some volunteer for content typing (English to Tamil), proof-reading(English or Tamil). If you are interested please write to <a href="mailto:administrator@praiseyourredeemer.org?Subject=Would like to volunteer">administrator@praiseyourredeemer.org</a>
									</p>
									<div class="blog-comments">
										<ul class="list-link">
											<li><a href='<c:url value="/" />' class="author">Home
													Page</a></li>
													<li><a href='#' class="author">Started Date: 11-June-2017</a></li>
