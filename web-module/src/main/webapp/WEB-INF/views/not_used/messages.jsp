					...
					<section class="grid">
						...
						<article class="column c-three-fourth">
							<div class="blog-post">
								<div class="slide-1">
									<ul>
										<li><img src=<c:url value="/resources/images/j1.jpg"/>
											alt="image" /></li>
									</ul>
									<div class="blog-date">
										<p>
								...
								<div class="blog-holder">
									<h4 class="post-title">
										<a href=<c:url value="/messages/our-god-is-loving-god" />>Our
											GOD is a loving GOD <span>1</span>
										</a>
									</h4>
									<p>John 3:16 (KJV) For God so loved the world, that he gave
							...
							<div class="blog-post">
								<div class="slide-1">
									<ul>
										<li><img
											src=<c:url value="/resources/images/remain.jpg"/> alt="image" /></li>
									</ul>
									<div class="blog-date">
										<p>
											20<br /> Jul
								...
								<div class="blog-holder">
									<h4 class="post-title">
										<a href=<c:url value="/messages/remain-in-me" />>Remain in
											me <span>2</span>
										</a>
									</h4>
									<p>John 15:4 Abide in me, and I in you. As the branch
									...
									<div class="blog-comments">
										<ul class="list-link">
											<li><a href="#" class="author">By Praise Your
													Redeemer</a></li>
											<li><a href=<c:url value="/messages/remain-in-me" />
												class="section">Read More</a></li>
										</ul>
									</div>
								</div>
							...
							<div class="blog-post">
								<div class="slide-1">
									<ul>
										<li><img
											src=<c:url value="/resources/images/gods-power.jpg"/>
											alt="image" /></li>
									</ul>
									<div class="blog-date">
										<p>
								...
								<div class="blog-holder">
									<h4 class="post-title">
										<a href=<c:url value="/messages/gods-power" />>God's Power
											<span>3</span>
										</a>
									</h4>
									<p>Judges 15:15 Samson killed 1000 people with the Jaw bone
										of Ass.</p>
									<div class="blog-comments">
										<ul class="list-link">
											<li><a href="#" class="author">By Praise Your
													Redeemer</a></li>
											<li><a href=<c:url value="/messages/gods-power" />
												class="section">Read More</a></li>
										</ul>
									</div>
								</div>
