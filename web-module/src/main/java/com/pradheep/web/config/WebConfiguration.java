...
public class WebConfiguration extends WebMvcConfigurerAdapter {
	...
	/*
	 * @Bean(name = "quiz-microservice-client") public MicroserviceClient
	 * getMicroServiceClient() { MicroserviceClient client = new
	 * MicroserviceClient(); return client; }
	 */

	/*@Bean(name = "myRibbonClient")
	public MyRibbonClient getRibbonClient() {
		MyRibbonClient client = new MyRibbonClient();
		return client;
