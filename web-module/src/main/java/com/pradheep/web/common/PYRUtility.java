...
public class PYRUtility {
	...
	public static void creationTest(){
		String arg ="வேதாகமம் ஒருவருடைய படைப்பு அல்ல , அது அநேகரால் எழுதப்பட்டது ஆகும் . உதாரணமாக ராஜாக்கள் , மேய்ப்பர்கள் , விவசாயிகள் , கவிஞர்கள் , மீண் பிடிப்பவர்கள் அவர்களால் எழுதப்பட்டது .";
